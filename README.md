...
![](https://img.shields.io/github/contributors/divanoLetto/Virtual_Reality_Game_DRL?color=light%20green) ![](https://img.shields.io/github/repo-size/divanoLetto/Virtual_Reality_Game_DRL)
...
Details about the implementation, training, various types of enemies and the obtained results can be found in the `docs` folder.
...
![Alt Text](https://github.com/divanoLetto/Virtual_Reality_Game_DRL/blob/master/Images/videoVrGame.gif width="60%")
